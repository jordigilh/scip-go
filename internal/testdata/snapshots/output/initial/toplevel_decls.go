...
//⌄ enclosing_range_start 0.1.test `sg/initial`/MY_THING.
  const MY_THING = 10
...
//                  ⌃ enclosing_range_end 0.1.test `sg/initial`/MY_THING.
//⌄ enclosing_range_start 0.1.test `sg/initial`/OTHER_THING.
...
//                           ⌃ enclosing_range_end 0.1.test `sg/initial`/OTHER_THING.
...
//⌄ enclosing_range_start 0.1.test `sg/initial`/initFunctions.
...
//                  signature_documentation
//                  > var initFunctions map[string]int
//                                   ⌃ enclosing_range_end 0.1.test `sg/initial`/initFunctions.
